...
public class BreastCancerClassifierTest {
    ...
    public void testCalculateDistance() {
        ...
        double dist1D = 6.0;
        double studentAnswer1D = BreastCancerClassifier.calculateDistance(first1D, second1D);
        ...
        double studentAnswer2D = BreastCancerClassifier.calculateDistance(first2D, second2D);
        ...
        double studentAnswer3D = BreastCancerClassifier.calculateDistance(first3D, second3D);
    ...
    public void testGetAllDistances() {
        ...
        double[] student_answer = BreastCancerClassifier.getAllDistances(trainData, testInstance);
        ...
        double[] student_answer2D = BreastCancerClassifier.getAllDistances(trainData2D, testInstance2D);
        assertEquals("Output array does not match length of the training data input array.",
    ...
    public void testFindKClosestEntries() {
        ...
        int[] studentKClosestIndexes = BreastCancerClassifier.findKClosestEntries(distances01);
        ...
        int[] studentKClosestIndexes2 = BreastCancerClassifier.findKClosestEntries(distances02);
        // sort for comparision
         ...
         */
        try {
            Class c = BreastCancerClassifier.class;
            ...
            int[] studentKClosestIndexes3 = BreastCancerClassifier.findKClosestEntries(distances03);
            // sort for comparision
    ...
    public void testClassify() {
        ...
        assertEquals("Did not correctly classify a test case when the KNN are bengign.",
                2, BreastCancerClassifier.classify(trainDataBenign, kClosestIndicesBenign));
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        assertEquals("Did not correctly classify a test case when the KNN are malignant.",
                4, BreastCancerClassifier.classify(trainDataMalignant, kClosestIndicesMalignant));
        ...
        try {
            ...
            assertEquals("Did not correctly classify a test case when the labels for the KNN are tied.",
                2, BreastCancerClassifier.classify(trainDataTie, kClosestIndicesTie));
        }
        catch (Exception e){
            e.printStackTrace();
            fail("Missing class field K. Did you delete or modify it?");
        ...
        try {
            ...
            assertEquals("Failed when the label for benign changed. Did you hard-code this value?",
                    NEW_BENIGN_LABEL, BreastCancerClassifier.classify(trainDataNewBenign, kClosestIndicesNewBenign));
            ...
            assertEquals("Failed when the label for benign changed. Did you hard-code this value?",
                    NEW_MALIGNANT_LABEL, BreastCancerClassifier.classify(trainDataNewMalig, kClosestIndicesNewMalig));
        }
        catch (Exception e){
            fail("Missing class field K. Did you delete or modify it?");
        }
    ...
    public void testKNearestNeighbors() {
        ...
        int[] student_bcc_predictions = BreastCancerClassifier.kNearestNeighbors(bcc_training_data, bcc_testing_data);
        /*
        ...
        int[] student_parkinsons_predictions = BreastCancerClassifier.kNearestNeighbors(parkinsons_training_data, parkinsons_testing_data);
        */
    ...
    public void testGetAccuracy() {
        ...
        String student_perfect_score = BreastCancerClassifier.getAccuracy(perect_student, perfect_results);
        ...
        String student_zero_score = BreastCancerClassifier.getAccuracy(zero_student, zero_results);
        ...
        String one_third_score = BreastCancerClassifier.getAccuracy(one_third_student, one_third_results);
        ...
        String two_third_score = BreastCancerClassifier.getAccuracy(two_third_student, two_third_results);
