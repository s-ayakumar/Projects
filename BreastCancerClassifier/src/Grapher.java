...
/**
 * The Grapher class creates a JPanel displaying a graph of pairwise distances.
 * The upper left corner represents pairwise distances between benign clumps, 
 * and the bottom right corner represents distances between malignant clumps. 
 * 
 * Darker colors represent closer distances, and lighter colors represent farther
 * distances. If calculateDistance is correctly implemented, the top left
 * and bottom right corners should be dark, and the other two areas should be light.
 */
 public class Grapher extends JPanel {
     ...
     * Prints axes titles and pixel array. 
     */
    public void paintComponent(Graphics g) {
        ...
        for(int i = 0; i < trainData.length; i++)
        {
        	...
        	{
        		double dist = BreastCancerClassifier.calculateDistance(trainData[i], trainData[j]);
        		if(dist > maxDist) {
        			maxDist = dist;
        		}
        	}
